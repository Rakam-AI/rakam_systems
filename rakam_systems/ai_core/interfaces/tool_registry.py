...
class ToolMetadata:
    ...
    def __init__(
        ...
        description: str,
        mode: str,
        tool_instance: Optional[Union[Tool, ToolComponent]] = None,
...
class ToolRegistry:
    ...
    def register_tool_instance(
        self,
        tool: Union[Tool, ToolComponent],
        category: Optional[str] = None,
        tags: Optional[List[str]] = None,
    ) -> None:
        """
        Register an existing Tool or ToolComponent instance.
        
        Args:
            tool: Tool or ToolComponent instance
            category: Optional category for organizing tools
            tags: Optional tags for filtering tools
        """
        ...
        elif isinstance(tool, ToolComponent):
            metadata = ToolMetadata(
                name=tool.name,
                description=getattr(tool, 'description', f"Tool component: {tool.name}"),
                mode=ToolMode.DIRECT,
                tool_instance=tool,
                category=category,
                tags=tags,
