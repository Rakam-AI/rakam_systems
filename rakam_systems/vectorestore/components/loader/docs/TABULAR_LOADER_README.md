...
```python
from rakam_systems.ai_vectorstore.components.loader.tabular_loader import create_tabular_loader
...
```python
from rakam_systems.ai_vectorstore.components.loader.tabular_loader import (
