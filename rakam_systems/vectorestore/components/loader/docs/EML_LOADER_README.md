...
The EML loader is part of the `rakam_systems.ai_vectorstore` package. Ensure you have the required dependencies:
...
```python
from rakam_systems.ai_vectorstore.components.loader import create_eml_loader
