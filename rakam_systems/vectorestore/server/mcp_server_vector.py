...
Example:
    >>> from rakam_system_vectorstore.server.mcp_server_vector import run_vector_mcp
    >>> from rakam_system_vectorstore.components.vectorstore.configurable_pg_vector_store import ConfigurablePgVectorStore
    >>> 
...
from rakam_systems.core.ai_core.mcp.mcp_server import MCPServer
from rakam_systems.core.ai_core.interfaces import ToolComponent
