...
def vector_store_fixture():
    ...
    store_files = {collection_name: vs_files}
    vector_store.create_collections_from_files(store_files)

    return vector_store, collection_name

# Test function using the fixture
def test_vector_store_operations(vector_store_fixture):
    vector_store, collection_name = vector_store_fixture
    ...
    vector_store.add_nodes(collection_name, [new_node])
